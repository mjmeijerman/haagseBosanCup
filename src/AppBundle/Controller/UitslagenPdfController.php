...
class UitslagenPdfController extends AlphaPDFController
{
    ...
    function Header()
    {
        ...
        $this->Image('images/HBCFactuurheader.png', 30, -1);
        $this->Ln(30);
        ...
        $header2 = array('Nr.', 'Naam', 'Vereniging', 'D1', 'N1', 'Spr1', 'D2', 'N2', 'Spr2', 'Pnt', 'Pl', 'D', 'N',
            'Pnt', 'Pl', 'D', 'N', 'Pnt', 'Pl', 'D', 'N', 'Pnt', 'Pl', 'Pnt', 'Pl');
    ...
    function Table($turnsters)
    {
        foreach ($turnsters as $turnster) {
            ...
            $this->Cell(11,6,$turnster['totaalSprong1'],1,0);
            $this->Cell(8,6,$turnster['dSprong2'],1,0);
            $this->Cell(8,6,$turnster['nSprong2'],1,0);
            $this->Cell(11,6,$turnster['totaalSprong2'],1,0);
            $this->Cell(11,6,$turnster['totaalSprong'],1,0);
            if(in_array($turnster['rankSprong'],[1,2,3])) {
                $this->SetFont('Helvetica','B',7);
                $this->Cell(5,6,$turnster['rankSprong'],1,0, "", true);
                $this->SetFont('Helvetica','',7);
            } else {
                $this->Cell(5,6,$turnster['rankSprong'],1,0);
            }

            $this->Cell(8,6,$turnster['dBrug'],1,0);
            $this->Cell(8,6,$turnster['nBrug'],1,0);
            $this->Cell(11,6,$turnster['totaalBrug'],1,0);
            ...
            if(in_array($turnster['rankBalk'],[1,2,3])) {
                ...
                $this->Cell(5,6,$turnster['rankBalk'],1,0);
            }

            $this->Cell(8,6,$turnster['dVloer'],1,0);
            $this->Cell(8,6,$turnster['nVloer'],1,0);
            $this->Cell(11,6,$turnster['totaalVloer'],1,0);
            if(in_array($turnster['rankVloer'],[1,2,3])) {
                $this->SetFont('Helvetica','B',7);
                $this->Cell(5,6,$turnster['rankVloer'],1,0, "", true);
                $this->SetFont('Helvetica','',7);
            } else {
                $this->Cell(5,6,$turnster['rankVloer'],1,0);
            }

            $this->Cell(11,6,$turnster['totaal'],1,0);
            if(in_array($turnster['rank'],[1,2,3])) {
                $this->SetFont('Helvetica','B',7);
                $this->Cell(5,6,$turnster['rank'],1,0, "", true);
                $this->SetFont('Helvetica','',7);
            } else {
                $this->Cell(5,6,$turnster['rank'],1,0);
            }
            $this->Ln();
        }
    }
